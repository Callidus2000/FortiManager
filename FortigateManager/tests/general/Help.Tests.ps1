...
foreach ($command in $commands) {
	...
	Describe "Test help for $commandName" {
        ...
        Context "Test parameter help for $commandName" {
            ...
            $common = 'Debug', 'ErrorAction', 'ErrorVariable', 'InformationAction', 'InformationVariable', 'OutBuffer', 'OutVariable', 'PipelineVariable', 'Verbose', 'WarningAction', 'WarningVariable', 'WhatIf', 'Confirm','ProgressAction'
