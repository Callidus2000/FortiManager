...
Remove-Module FortigateManager -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\FortigateManager.psd1"
Import-Module "$PSScriptRoot\..\FortigateManager.psm1" -Force
