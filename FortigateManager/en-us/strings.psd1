...
@{
	...
	'APICall.Get-FMADeviceInfo'              = '#{0}: Query analyzer DeviceInfo for ADOM {1}'
	...
	'APICall.Get-FMDeviceInterface'          = '#{0}: Query Interface Info of device {1} and vdom {2}'
	'APICall.Get-FMDeviceStaticRoute'        = '#{0}: Query Static Routes of device {1} and vdom {2}'
	'APICall.Get-FMDeviceZone'               = '#{0}: Query Zone Info of device {1} and vdom {2}'
	...
	'APICall.Remove-FMALogSearch'            = '#{0}: Remove LogSearch Task #{1}'
